...
export const metadata: Metadata = {
  title: "Tender Services & GeM Support - Niyamak Tender Solution",
  description:
    "Explore our tender submission, bid management, tender analysis, compliance checks, DSC setup guidance, and GeM portal support including authorization codes and follow-ups.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-left">
                ...
                <p className="text-xl text-gray-200 mb-8 max-w-xl leading-relaxed">
                  We provide end-to-end tender management services to help your
                  business succeed in the competitive tender landscape.
                </p>
                <div className="flex flex-wrap gap-4">
                  <a
                    href="#services"
                    className="group bg-white text-black-600 px-8 py-4 rounded-full font-semibold hover:bg-emerald-50 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 group btn-primary rounded-full px-8 py-4 text-base"
                  >
                    Explore Services
                    <svg
                  ...
                  <a
                    href="/contact"
                    className="group border-2 border-white text-black px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-emerald-600 transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
                  >
                    Get Started
                    <svg
                      className="w-5 h-5 transform group-hover:translate-x-1 transition-transform"
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              We offer a comprehensive range of tender management services to
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-emerald-600 mx-auto"></div>
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              We follow a systematic approach to deliver exceptional tender
              management services.
            </p>
          </div>
            ...
            {processSteps.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  <div className="bg-emerald-50 rounded-full w-16 h-16 flex items-center justify-center text-emerald-600 font-bold text-xl mb-6">
                    {step.number}
                  </div>
            ...
            {[
              {
                title: "Expert Team",
                description:
                  "Our team of professionals brings years of industry experience and expertise.",
                icon: "👥",
              },
              {
                title: "Proven Track Record",
                description:
                  "We have a history of successful tender submissions and satisfied clients.",
                icon: "🏆",
              },
              {
